...
add wave -noupdate -childformat {{/tbcoarsealignment/DUV/regCoarse.Threshold -radix decimal} {/tbcoarsealignment/DUV/regCoarse.SampleCounter -radix unsigned} {/tbcoarsealignment/DUV/regCoarse.Delay -radix unsigned} {/tbcoarsealignment/DUV/regCoarse.Offset -radix unsigned}} -expand -subitemconfig {/tbcoarsealignment/DUV/regCoarse.Threshold {-radix decimal} /tbcoarsealignment/DUV/regCoarse.SampleCounter {-height 15 -radix unsigned} /tbcoarsealignment/DUV/regCoarse.Delay {-height 15 -radix unsigned} /tbcoarsealignment/DUV/regCoarse.Offset {-height 15 -radix unsigned}} /tbcoarsealignment/DUV/regCoarse
add wave -noupdate -radix decimal -childformat {{/tbcoarsealignment/DUV/regPValue.I -radix decimal} {/tbcoarsealignment/DUV/regPValue.Q -radix decimal}} -expand -subitemconfig {/tbcoarsealignment/DUV/regPValue.I {-clampanalog 1 -format Analog-Interpolated -height 200 -max 500000000.0 -min -500000000.0 -radix decimal} /tbcoarsealignment/DUV/regPValue.Q {-clampanalog 1 -format Analog-Interpolated -height 200 -max 500000000.0 -min -500000000.0 -radix decimal}} /tbcoarsealignment/DUV/regPValue
...
update
WaveRestoreZoom {0 ps} {47701605 ps}
